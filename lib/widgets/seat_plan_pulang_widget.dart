...
class _SeatPlanPulangWidgetScreen extends State<SeatPlanPulangWidget> {
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () {
                      if (li.length >=
                          ...
                          !li.contains(slot.pulang_name)) {
                      } else {
                        if (!slot.pulang_isAvailable) {
                          ...
                          if (li.contains(slot.pulang_name)) {
                            setState(() {
                              li.removeWhere(
                                  (element) => element == slot.pulang_name);
                              list[index] = !list[index];
                            });
                          } else {
                            setState(() {
                              list[index] = !list[index];
                              li.add(slot.pulang_name);
                            });
                          }
                        }
                      }
  ...
  void getSlotList() {
    ...
    for (int i = 0; i < data; i++) {
      SlotPulang slot = _slotList[i];
      list.add(slot.pulang_isAvailable);
    }
  }
}
