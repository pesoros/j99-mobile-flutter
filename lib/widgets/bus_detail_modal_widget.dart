...
class BusDetailModalWidget extends StatefulWidget {
  final BusPergi bus;
  ...
  @override
  _BusDetailModalWidgetState createState() => _BusDetailModalWidgetState();
}

class _BusDetailModalWidgetState extends State<BusDetailModalWidget> {
  BusPergi bus;
  List list = [];
  int index = 0;
